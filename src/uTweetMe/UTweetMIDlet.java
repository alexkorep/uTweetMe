...
//GEN-LINE:|7-commandAction|86|389-postAction
   ...
   public void IsConfigured() {//GEN-END:|63-if|0|63-preIf
      ...
      if ((Settings.GetInstance().GetSettings().m_name.length() != 0) &&//GEN-BEGIN:|63-if|1|64-preAction
            ...
            // write pre-action user code here
         /*
			if (null == m_oAuthLogin)
			{
				m_oAuthLogin = new XAuthLogin(this, m_app.GetLoginManager());
			}
			m_oAuthLogin.switchDisplayable(null, m_oAuthLogin.getFrmOAuthUsername());
          */
         switchDisplayable(null, getFrmConfig());
//GEN-LINE:|63-if|4|65-postAction
            // write post-action user code here
...
//GEN-LINE:|17-itemCommandAction|2|354-postAction
   ...
   //<editor-fold defaultstate="collapsed" desc=" Generated Getter: cmdUsernamePassword ">//GEN-BEGIN:|400-getter|0|400-preInit
   /**
    * Returns an initiliazed instance of cmdUsernamePassword component.
    * @return the initialized component instance
    */
   public Command getCmdUsernamePassword() {
      if (cmdUsernamePassword == null) {//GEN-END:|400-getter|0|400-preInit
         // write pre-init user code here
         cmdUsernamePassword = new Command("Item", Command.ITEM, 0);//GEN-LINE:|400-getter|1|400-postInit
         // write post-init user code here
      }//GEN-BEGIN:|400-getter|2|
      return cmdUsernamePassword;
   }
